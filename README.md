...
**74 authored patients across 7 wards**, of whom five are dealt each morning —
**144 boards** a career can reach, the order of the wards drawn per career as
...
294 smoke checks — boots the real scene and plays a whole shift, on three seeds
 ...
 39 playtests    — day-level, against 7 criteria: does the risk actually cost
  ...
  7 wards        — 2,601 strategies searched per ward, adversarially
144 deals        — every board a career can reach, played honestly
  2 play runs    — the buttons actually pressed, pad and keyboard
 30 screenshots  — rendered offscreen, because the count of bugs found only by
