...
const CATALOGUE := {
	...
	"private_rooms": {
		"name": "Convert to Private Rooms", "cost": 8800, "tier": 2,
	...
	"security_cameras": {
		"name": "Corridor Cameras", "cost": 6400, "tier": 2,
